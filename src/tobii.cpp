...
TX_GAZEPOINTDATAEVENTPARAMS tobii::eventParams;
/*
...
void OnGazeDataEvent(TX_HANDLE hGazeDataBehavior)
{
	...
	if (txGetGazePointDataEventParams(hGazeDataBehavior, &(tobii::eventParams)) == TX_RESULT_OK) {
		//printf("Gaze Data: (%.1f, %.1f) timestamp %.0f ms\n", tobii::eventParams.X, tobii::eventParams.Y, tobii::eventParams.Timestamp);
	} else {
